...
public class dich_vu {
    ...
    String ten_dich_vu;
    ArrayList<String> anh_dich_vu;

    public dich_vu(int id_dich_vu, int id_loai_dich_vu, int gia_dich_vu, String ten_dich_vu, ArrayList<String> anh_dich_vu) {
    ...
    public ArrayList<String> getAnh_dich_vu() {
        return anh_dich_vu;
    }

    public void setAnh_dich_vu(ArrayList<String> anh_dich_vu) {
        this.anh_dich_vu = anh_dich_vu;
    }
