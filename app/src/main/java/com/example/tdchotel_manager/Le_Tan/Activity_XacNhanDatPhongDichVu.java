    ...
    private void setEvent() {
        ...
        btnXacNhanDV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Date now=new Date();
                    thoi_gian_nhan = new SimpleDateFormat("dd/MM/yyyy HH:mm").parse(btnNgayNhan.getText().toString());
                    thoi_gian_tra = new SimpleDateFormat("dd/MM/yyyy HH:mm").parse(btnNgayTra.getText().toString());
                            ...
                            for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                                ...
                                if(hoa_don.getThoi_gian_thanh_toan().equals("")&&hoa_don.getId_phong().equals(phong.getId_phong())){
                                    try{
                                        ...
                                        thoi_gian_hoadon_nhan = new SimpleDateFormat("dd/MM/yyyy HH:mm").parse(hoa_don.getThoi_gian_nhan_phong().toString());
                                        thoi_gian_hoadon_tra = new SimpleDateFormat("dd/MM/yyyy HH:mm").parse(hoa_don.getThoi_gian_tra_phong().toString());
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog.OnDateSetListener dataListener = new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                        ...
                        new TimePickerDialog(Activity_XacNhanDatPhongDichVu.this, timeSetListener, calendar.get(Calendar.HOUR_OF_DAY), calendar.get(Calendar.MINUTE), false).show();
                    }
                };
